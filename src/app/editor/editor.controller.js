      ...
      $scope.handleClick = function (event, theId) {
        switch(event.which) {
                ...
                case 3:
                    ...
                    document.getElementById('tweet-button').style.top = (offsetHeight-100).toString() + 'px';
                    document.getElementById('tweet-button').style.left = (offsetWidth-100).toString() + 'px';
