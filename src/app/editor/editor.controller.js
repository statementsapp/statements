    ...
    $scope.mainLoop = function () {
      ...
      $scope.prepProposition = function (input, node, paragraph, proposition, event, flag, automatedAuthor, automatedCode, authorNumber, rejoinderMessaged, onRemarkId ) {
        ...
        // Rejoinders: gone as standalones
          ...
          prep.messagesSoFar = [prep.id]
                  ...
                  ($scope.selectedProposition.type === 'assertion' && (node && ($scope.userId === node.sectionClaimedBy  || (node.isTitle && $scope.data[0].documentClaimedBy === $scope.userId))) || $scope.selectedProposition.dialogueSide) && 
        ...
        prep.payload = {
          authorNumber: (authorNumber) ? authorNumber : (event.authorNumber) ? event.authorNumber : (event.authorNumber !== undefined) ? event.authorNumber : authorNumber === 0 ? authorNumber : undefined,
      ...
      $scope.setupScript = function () {
        ...
        $timeout(function () {
            ...
            $scope.coinbase3 = { authorNumber: 2, stack: [], sequence: [
              { index: 0, 
            ...
            $scope.safety3 = { authorNumber: 2, stack: [], sequence: [
              ...
              $scope.gamesone = { authorNumber: 0, stack: [], sequence: [
                ...
                { index: 4, 
                    ...
                    author: 'aaa',
                    text: 'People just have to “calculate” strategies for the new layers of the game, satisfying our requirement that games be fairly competitive.',
                    dialogueText: function() {
                                    return this.text;
                                  },
                    type: 'negation',
