      ...
      $scope.handleClick = function (event, theId) {
        switch(event.which) {
                ...
                case 3:
                    ...
                    var offsetHeight = document.getElementById('wholeprop' + theId).getBoundingClientRect().top*0;
                    var offsetWidth = document.getElementById('wholeprop'+ theId).getBoundingClientRect().left*0;
